...
const MANAGEMENT_CLIENT_NAME = "KzBarry Management"
const DASHBOARD_CLIENT_NAME = "KzBarry Dashboard"
const DEFAULT_CONNECTION_NAME = "KzBarry-Shared-Database"
...
try {
  ...
  const createClientArgs = [
    ...
    "--description", "The KzBarry client to manage tenant resources and facilitate account creation.",
